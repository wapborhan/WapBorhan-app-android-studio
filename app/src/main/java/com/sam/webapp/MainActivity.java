...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_Email) {
            ...
            intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"infoborhan@gmail.com"});
            intent.putExtra(Intent.EXTRA_SUBJECT, "Subject");
            intent.putExtra(Intent.EXTRA_TEXT, "Mail Body");
            startActivity(Intent.createChooser(intent, "Email Via"));
        }
        if (id == R.id.action_Contact) {
            String phone = "+8801620557840";
        ...
        if (id == R.id.share){
            ...
            i.putExtra(Intent.EXTRA_TEXT, "Download my app https://wapborhan.com/app");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        String fb = "infoborhan";
        String twt = "wapborhan";
        String ig = "wapborhan";
        String lin = "wapborhan";
        String amzn = "https://wa.me/+8801620557840?text=Hello";
        String flpkrt = "https://t.me/wapborhan";
        int id = item.getItemId();
                if (id == R.id.nav_facebook) {
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://linkedin.com/in/"+lin)));
                } else if (id == R.id.nav_insta) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/"+ig)));
    ...
    private void checkConnection() {
        if (isOnline()){
            String url = "https://wapborhan.com/"; //Enter your url here
            webView.loadUrl(url);
